    ...
    public render(){
        ...
        <div className="list-group-item flex-column align-items-start">
            <div className="d-flex w-100 justify-content-between">
                ...
                <button type="button" className="btn base-color" onClick={this.addLike}>
                    ★ {q.like}
                </button>
            </div>
            <footer className="blockquote-footer">{q.username} at {q.createdAt.toISOString()}</footer>
        </div>
        );
    }
...
export default connect<StateToProps,DispatchToProps, MyProps>(mapStateToProps, mapDispatchToProps)(QuestionElement);
